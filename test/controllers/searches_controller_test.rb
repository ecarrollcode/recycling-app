...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { slug: @search.slug, text: @search.text, zip: @search.zip } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { slug: @search.slug, text: @search.text, zip: @search.zip } }
