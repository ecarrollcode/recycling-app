...
Item.create!([
  ...
  {item_id: 9, name: "office paper", category: "papers", bin: "recycle", info: "Americans throw away enough office paper each year to build a new 12 foot high wall from Seattle to NY every year. (recycleAcrossAmerica)", cities: "Claremont, CA", recycling_plants: "RP1", img_path: ""},
  ...
  {item_id: 29, name: "Cardboard boxes", category: "cardboard", bin: "recycle", info: "Over 90% of all products shipped in the US are shipped in corrugated boxes, which totals more than 400 billion square feet of cardboard. (recycleAcrossAmerica)", cities: "Claremont, CA", recycling_plants: "RP1", img_path: ""},
  ...
  {item_id: 42, name: "Plastic water bottles", category: "plastic", bin: "recycle", info: "Americans throw away 2.5 million plastic bottles every hour. (recycleAcrossAmerica)", cities: "Claremont, CA", recycling_plants: "RP1", img_path: ""},
  {item_id: 43, name: "Plastic soda bottles", category: "plastic", bin: "recycle", info: "Americans throw away 2.5 million plastic bottles every hour. (recycleAcrossAmerica)", cities: "Claremont, CA", recycling_plants: "RP1", img_path: ""},
  ...
  {item_id: 52, name: "Aluminum soda cans", category: "metals", bin: "recycle", info: "Recycling a single aluminum can saves enough energy to power a TV for three hours. (recycleAcrossAmerica)", cities: "Claremont, CA", recycling_plants: "RP1", img_path: ""},
  {item_id: 53, name: "Aluminum beer cans", category: "metals", bin: "recycle", info: "Recycling a single aluminum can saves enough energy to power a TV for three hours. (recycleAcrossAmerica)", cities: "Claremont, CA", recycling_plants: "RP1", img_path: ""},
